...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _eventos_eventos_component__WEBPACK_IMPORTED_MODULE_5__["EventosComponent"], _nav_nav_component__WEBPACK_IMPORTED_MODULE_7__["NavComponent"]],
    ...
    function () {
      ...
      _createClass(EventosComponent, [{
        ...
        value: function AlternarImagem() {
          this.mostrarImagem = !this.mostrarImagem; // tslint:disable-next-line: prefer-const

          var element = document.getElementById('lblMostrarImagem');

          if (this.mostrarImagem) {
            element.innerText = 'Ocultar Imagem';
          } else {
            element.innerText = 'Mostrar Imagem';
          }
        }
      }, {
        key: "GetEventos",
        ...
        value: function filtrarEvento(filtroLista) {
          return this.eventos.filter(function (f) {
            return f.tema.toLocaleLowerCase().indexOf(filtroLista.toLocaleLowerCase()) !== -1;
          });
        }
      }, {
        key: "retornaEventos",
        value: function retornaEventos() {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Teste_DotNetCore\ProAgil-App\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
