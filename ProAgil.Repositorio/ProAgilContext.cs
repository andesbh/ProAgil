    ...
    public class ProAgilContext :IdentityDbContext<User, Role, int, IdentityUserClaim<int>, UserRole, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserRole>(userRole =>
            {
                ...
                userRole.HasOne(ur => ur.Role).WithMany(lu => lu.UserRoles).HasForeignKey(ur => ur.RoleId).IsRequired();
                userRole.HasOne(ur => ur.User).WithMany(lu => lu.UserRoles).HasForeignKey(ur => ur.UserId).IsRequired();
            });
