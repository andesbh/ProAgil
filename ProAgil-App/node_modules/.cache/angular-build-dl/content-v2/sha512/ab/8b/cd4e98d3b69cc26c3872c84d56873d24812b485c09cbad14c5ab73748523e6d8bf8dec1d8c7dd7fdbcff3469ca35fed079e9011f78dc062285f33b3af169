...
let EventosComponent = class EventosComponent {
    ...
    AlternarImagem() {
        ...
        let element = document.getElementById('lblMostrarImagem');
    ...
    filtrarEvento(filtroLista) {
        return this.eventos.filter(f => f.tema.toLocaleLowerCase().indexOf(filtroLista.toLocaleLowerCase()) !== -1);
    }
    retornaEventos() {
...
module.exports = __webpack_require__(/*! C:\Teste_DotNetCore\ProAgil-App\src\main.ts */"./src/main.ts");
